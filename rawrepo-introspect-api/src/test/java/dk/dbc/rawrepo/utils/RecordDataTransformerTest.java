...
public class RecordDataTransformerTest {
    ...
    public void testRecordDiffToText_LINE() throws Exception {
        ...
        assertThat(new String(actual.getRecordParts().get(0).getContent()), is("001 00 *a47097886*b870970*c20190930123826*d20190911*fa\n"));
        assertThat(actual.getRecordParts().get(0).getType(), is("both"));
        assertThat(actual.getRecordParts().get(0).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(1).getContent()), is("004 00 *rn*ae\n"));
        assertThat(actual.getRecordParts().get(1).getType(), is("both"));
        assertThat(actual.getRecordParts().get(1).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(2).getContent()), is("504 00 *&1*aFra en gummibåd på Hudson River i Seattle i 1950'erne fortæller her\n"));
        assertThat(actual.getRecordParts().get(2).getType(), is("right"));
        assertThat(actual.getRecordParts().get(2).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(3).getContent()), is("    oinmisbrugeren Joe Necchi om sit liv samtidig med han er i gang med skrive \n"));
        assertThat(actual.getRecordParts().get(3).getType(), is("right"));
        assertThat(actual.getRecordParts().get(3).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(4).getContent()), is("    en bog\n"));
        assertThat(actual.getRecordParts().get(4).getType(), is("right"));
        assertThat(actual.getRecordParts().get(4).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(5).getContent()), is("504 00 *&1*aFra en flodpram på Hudson River i New York i 1950'erne fortæller he\n"));
        assertThat(actual.getRecordParts().get(5).getType(), is("left"));
        assertThat(actual.getRecordParts().get(5).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(6).getContent()), is("    roinmisbrugeren Joe Necchi om sit liv samtidig med han er i gang med skrive\n"));
        assertThat(actual.getRecordParts().get(6).getType(), is("left"));
        assertThat(actual.getRecordParts().get(6).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(7).getContent()), is("     en bog\n"));
        assertThat(actual.getRecordParts().get(7).getType(), is("left"));
        assertThat(actual.getRecordParts().get(7).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(8).getContent()), is("996 00 *aDBC\n"));
        assertThat(actual.getRecordParts().get(8).getType(), is("both"));
        assertThat(actual.getRecordParts().get(8).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(9).getContent()), is("$\n"));
        assertThat(actual.getRecordParts().get(9).getType(), is("both"));
        assertThat(actual.getRecordParts().get(9).getEncoding(), is("utf8"));
    }
    ...
    public void testRecordDiffToText_XML() throws Exception {
        ...
        assertThat(new String(actual.getRecordParts().get(0).getContent()), is("<?xml version=\"1.0\" encoding=\"utf8\"?>\n"));
        assertThat(actual.getRecordParts().get(0).getType(), is("both"));
        assertThat(actual.getRecordParts().get(0).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(1).getContent()), is("<record xmlns=\"urn:info:lc/xmlns/marcxchange-v1\" xmlns:xsi=\"urn:http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"info:lc/xmlns/marcxchange-v1 http://www.loc.gov/standards/iso25577/marcxchange-1-1.xsd\">\n"));
        assertThat(actual.getRecordParts().get(1).getType(), is("both"));
        assertThat(actual.getRecordParts().get(1).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(2).getContent()), is("    <leader>00000     22000000 4500 </leader>\n"));
        assertThat(actual.getRecordParts().get(2).getType(), is("both"));
        assertThat(actual.getRecordParts().get(2).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(3).getContent()), is("    <datafield ind1=\"0\" ind2=\"0\" tag=\"001\">\n"));
        assertThat(actual.getRecordParts().get(3).getType(), is("both"));
        assertThat(actual.getRecordParts().get(3).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(4).getContent()), is("        <subfield code=\"a\">47097886</subfield>\n"));
        assertThat(actual.getRecordParts().get(4).getType(), is("both"));
        assertThat(actual.getRecordParts().get(4).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(5).getContent()), is("        <subfield code=\"b\">870970</subfield>\n"));
        assertThat(actual.getRecordParts().get(5).getType(), is("both"));
        assertThat(actual.getRecordParts().get(5).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(6).getContent()), is("        <subfield code=\"c\">20190930123826</subfield>\n"));
        assertThat(actual.getRecordParts().get(6).getType(), is("both"));
        assertThat(actual.getRecordParts().get(6).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(7).getContent()), is("        <subfield code=\"d\">20190911</subfield>\n"));
        assertThat(actual.getRecordParts().get(7).getType(), is("both"));
        assertThat(actual.getRecordParts().get(7).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(8).getContent()), is("        <subfield code=\"f\">a</subfield>\n"));
        assertThat(actual.getRecordParts().get(8).getType(), is("both"));
        assertThat(actual.getRecordParts().get(8).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(9).getContent()), is("    </datafield>\n"));
        assertThat(actual.getRecordParts().get(9).getType(), is("both"));
        assertThat(actual.getRecordParts().get(9).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(10).getContent()), is("    <datafield ind1=\"0\" ind2=\"0\" tag=\"004\">\n"));
        assertThat(actual.getRecordParts().get(10).getType(), is("both"));
        assertThat(actual.getRecordParts().get(10).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(11).getContent()), is("        <subfield code=\"r\">n</subfield>\n"));
        assertThat(actual.getRecordParts().get(11).getType(), is("both"));
        assertThat(actual.getRecordParts().get(11).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(12).getContent()), is("        <subfield code=\"a\">e</subfield>\n"));
        assertThat(actual.getRecordParts().get(12).getType(), is("both"));
        assertThat(actual.getRecordParts().get(12).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(13).getContent()), is("    </datafield>\n"));
        assertThat(actual.getRecordParts().get(13).getType(), is("both"));
        assertThat(actual.getRecordParts().get(13).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(14).getContent()), is("    <datafield ind1=\"0\" ind2=\"0\" tag=\"504\">\n"));
        assertThat(actual.getRecordParts().get(14).getType(), is("both"));
        assertThat(actual.getRecordParts().get(14).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(15).getContent()), is("        <subfield code=\"&amp;\">1</subfield>\n"));
        assertThat(actual.getRecordParts().get(15).getType(), is("both"));
        assertThat(actual.getRecordParts().get(15).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(16).getContent()), is("        <subfield code=\"a\">Fra en gummibåd på Hudson River i Seattle i 1950'erne fortæller heroinmisbrugeren Joe Necchi om sit liv samtidig med han er i gang med skrive en bog</subfield>\n"));
        assertThat(actual.getRecordParts().get(16).getType(), is("right"));
        assertThat(actual.getRecordParts().get(16).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(17).getContent()), is("        <subfield code=\"a\">Fra en flodpram på Hudson River i New York i 1950'erne fortæller heroinmisbrugeren Joe Necchi om sit liv samtidig med han er i gang med skrive en bog</subfield>\n"));
        assertThat(actual.getRecordParts().get(17).getType(), is("left"));
        assertThat(actual.getRecordParts().get(17).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(18).getContent()), is("    </datafield>\n"));
        assertThat(actual.getRecordParts().get(18).getType(), is("both"));
        assertThat(actual.getRecordParts().get(18).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(19).getContent()), is("    <datafield ind1=\"0\" ind2=\"0\" tag=\"996\">\n"));
        assertThat(actual.getRecordParts().get(19).getType(), is("both"));
        assertThat(actual.getRecordParts().get(19).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(20).getContent()), is("        <subfield code=\"a\">DBC</subfield>\n"));
        assertThat(actual.getRecordParts().get(20).getType(), is("both"));
        assertThat(actual.getRecordParts().get(20).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(21).getContent()), is("    </datafield>\n"));
        assertThat(actual.getRecordParts().get(21).getType(), is("both"));
        assertThat(actual.getRecordParts().get(21).getEncoding(), is("utf8"));

        assertThat(new String(actual.getRecordParts().get(22).getContent()), is("</record>\n"));
        assertThat(actual.getRecordParts().get(22).getType(), is("both"));
        assertThat(actual.getRecordParts().get(22).getEncoding(), is("utf8"));
    }
